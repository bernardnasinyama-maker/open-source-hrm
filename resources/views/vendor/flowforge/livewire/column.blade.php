...
<div
    ...
    <!-- Column Header -->
    <div class="flowforge-column-header flex items-center justify-between py-3 px-4" style="border-bottom:1px solid rgba(255,255,255,.08)">
        <div class="flex items-center">
            @if ($column['icon'] ?? null)
                <x-filament::icon :icon="$column['icon']" class="h-4 w-4 text-gray-500 dark:text-gray-400 me-2" />
            @endif
            <h3 class="text-sm font-semibold" style="color:#f1f5f9">
                {{ $column['label'] }}
            </h3>
