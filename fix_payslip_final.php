...
// ============================================================
// 1. FIX REPORTSCONTROLLER - work with actual columns
// ============================================================
...
// ============================================================
// 2. FIX PAYSLIP BLADE - use new variables
// ============================================================
file_put_contents('resources/views/payslip.blade.php', '<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
    ...
    <div class="header">
        <div>
            ...
            <div class="company-sub">
                ...
                Contract No: UNRA/2023/SGR-EXT<br>
